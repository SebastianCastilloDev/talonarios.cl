...
function resultados(cantidad, moldes, multiplicidad, costoResma) {
    ...
    if (cantidad == 50) {
        ...
        if (multiplicidad == 2) {
            factor *= 0.8
        } else if (multiplicidad == 3) {
            factor *= 0.9
        } else if (multiplicidad == 4) {
            factor *= 1
        }
    ...
    const precioDeVenta = Math.ceil((factor * costoTotal * (1 + utilidad / 100) + impuesto / 100 * costoTotal * utilidad / 100) / 100) * 100
            ...
            valores.forEach(function (valor) {
                template += `
                    <tr class="lista__tr">
                        ...
                        <td class="lista__td">${$formatoNumero(valor.cantidad * 2)}</td>
